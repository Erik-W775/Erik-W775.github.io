...
The following entries and writeups are evidence of the hard and soft skills, and concepts that I have developed directly through the completion of class projects. The projects showcase my accomplishments and show that I can create and follow a plan to develop a product that meets specifications and scope. Achieving an education online has helped me develop additional soft skills that are not defined through coursework directly. These skills would not be possible if I had attended University in person and will serve me in my professional and personal life always. I have learned how to search online for assistance in completing projects and learning concepts in a way that allows me to learn without just getting a given answer. I have learned to read, study, and learn using electronic materials. This is an important skill that for me took a long time to master. I initially would print everything out to have a hard copy, this proved to be expensive, space consuming, and extremely wasteful. I now read, take notes, and study from on screen almost completely. I have had to be my own sounding board, critic, and tutor when completing and enhancing my schoolwork. I learned to be critical and subjective when reviewing and developing my research and written reports. I have communicated with and learned from classmates that are from different locations (states and countries), backgrounds, and with different goals through discussion boards and team projects which has added to the development my thought processes and approach to problem solving. 
